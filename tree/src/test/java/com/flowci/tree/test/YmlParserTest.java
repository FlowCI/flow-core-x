...
public class YmlParserTest {
    ...
    @Test
    void should_yml_exception_if_name_is_invalid() {
    ...
    @Test
    void should_get_correct_relationship_on_node_tree() {
        FlowNode root = YmlParser.load(content);
    ...
    @Test
    void should_parse_yml_with_exports_filter() throws IOException {
    ...
    @Test
    void should_parse_docker_and_dockers() throws IOException {
    ...
    @Test
    void should_throw_ex_when_runtime_has_command() throws IOException {
        assertThrows(YmlException.class, () -> {
    ...
    @Test
    void should_parse_step_in_step() throws IOException {
    ...
    @Test
    void should_throw_ex_when_plugin_defined_in_parent_step() {
        assertThrows(YmlException.class, () -> {
    ...
    @Test
    void should_load_parallel_step_yaml() throws IOException {
    ...
    @Test
    void should_load_and_get_post_steps() throws IOException {
        content = loadContent("flow-with-post.yml");
        FlowNode root = YmlParser.load(content);
        assertNotNull(root);
    ...
    private String loadContent(String resource) throws IOException {
        ...
        return StreamUtils.copyToString(classLoader.getResourceAsStream(resource), StandardCharsets.UTF_8);
    }
}
